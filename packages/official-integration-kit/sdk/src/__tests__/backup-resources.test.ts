...
describe("sdk backup resources", () => {
  it("creates export jobs, previews restore, and creates restore jobs", async () => {
    ...
    await expect(
      ...
      includedDomains: ["characters", "presets", "worldbooks", "regex_profiles", "sessions"],
      renamedResources: [
        {
          type: "session",
          oldName: "Story A",
