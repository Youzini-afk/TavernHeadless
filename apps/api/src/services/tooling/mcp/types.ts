...
export interface McpToolMetadataOverride {
  toolName: string;
...
export interface McpToolMetadataOverrideInput {
  tool_name: string;
  side_effect_level?: ToolSideEffectLevel;
  allowed_slots?: InstanceSlot[];
...
export interface McpServerConfig {
  ...
  /** 本地账号级 MCP tool metadata override */
...
export interface CreateMcpServerInput {
  ...
  metadata_overrides?: McpToolMetadataOverrideInput[];
}
