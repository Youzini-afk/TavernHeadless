    ...
    await this.db
      ...
      .onConflictDoUpdate({
        ...
        set: {
          ...
          presetVersionId: values.presetVersionId,
          presetContentHash: values.presetContentHash,
          worldbookId: values.worldbookId,
          worldbookUpdatedAt: values.worldbookUpdatedAt,
          worldbookVersion: values.worldbookVersion,
          worldbookVersionId: values.worldbookVersionId,
          worldbookContentHash: values.worldbookContentHash,
          ...
          regexProfileVersionId: values.regexProfileVersionId,
          regexProfileContentHash: values.regexProfileContentHash,
